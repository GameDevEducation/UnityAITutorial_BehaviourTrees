...
Sourced from: https://github.com/Deadcows/MyBox
    ...
    public class ConditionalFieldAttributeDrawer : PropertyDrawer
    {
        ...
        private void GetPropertyDrawerType(SerializedProperty property)
        {
            ...
            try
            {
                ...
                for (int index = 0; index < allAttributes.Count; ++index)
                {
                    if (allAttributes[index].GetType() == _genericAttribute.GetType())
                    {
                ...
                //Get arguments
                IList<CustomAttributeTypedArgument> attributeParams = fieldInfo.GetCustomAttributesData()[attributeIndex].ConstructorArguments;
